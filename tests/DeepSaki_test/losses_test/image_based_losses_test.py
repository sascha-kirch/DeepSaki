...
class TestImageBasedLossAbstractBase():
    ...
    @pytest.mark.parametrize("img_shape, normalize_last_channel, expected",[
...
class TestPixelDistanceLoss:
    ...
    @pytest.mark.parametrize("tensor1, tensor2, loss_type, expected",[
        (3*tf.ones(shape=[1,1,1,1]),tf.ones(shape=[1,1,1,1]), "mae", tf.constant(2.)),
        (3*tf.ones(shape=[8,64,64,4]),tf.ones(shape=[8,64,64,4]), "mae", tf.constant(2.)),
        (5*tf.ones(shape=[1,1,1,1]),tf.ones(shape=[1,1,1,1]), "mae", tf.constant(4.)),
        (5*tf.ones(shape=[8,64,64,4]),tf.ones(shape=[8,64,64,4]), "mae", tf.constant(4.)),
        (3*tf.ones(shape=[1,1,1,1]),tf.ones(shape=[1,1,1,1]), "mse", tf.constant(4.)),
        (3*tf.ones(shape=[8,64,64,4]),tf.ones(shape=[8,64,64,4]), "mse", tf.constant(4.)),
        (5*tf.ones(shape=[1,1,1,1]),tf.ones(shape=[1,1,1,1]), "mse", tf.constant(16.)),
        (5*tf.ones(shape=[8,64,64,4]),tf.ones(shape=[8,64,64,4]), "mse", tf.constant(16.)),
    ])
...
class TestSsimLoss:
    ...
    @pytest.mark.parametrize("tensor1, tensor2, expected",[
        (tf.ones(shape=[1,1,1,1]),tf.ones(shape=[1,1,1,1]),tf.constant(0.)),
        (tf.ones(shape=[8,64,64,4]),tf.ones(shape=[8,64,64,4]),tf.constant(0.)),
        (tf.ones(shape=[1,1,1,1]),tf.zeros(shape=[1,1,1,1]),tf.constant(1.)),
        (tf.ones(shape=[8,64,64,4]),tf.zeros(shape=[8,64,64,4]),tf.constant(1.)),
    ])
