...
class TestConv2DSplitted:
    ...
    @pytest.mark.parametrize("input, filters, kernels, strides, padding, expected_shape",[
    ...
    def test_call_correct_shape(self,input, filters, strides, padding, use_bias, use_spec_norm, kernels, expected_shape):
