...
class TestGlobalSumPooling2D:
    ...
    @pytest.mark.parametrize("data_format, expected_context",[
    ...
    @pytest.mark.parametrize("input,data_format, expected_shape",[
...
class TestLearnedPooling:
    ...
    @pytest.mark.parametrize("input, pool_size, expected_shape",[
