...
class rFFTPooling2D(tf.keras.layers.Layer):
    ...
    def __init__(self, isChannelFirst=False, truncatedFrequencies="low", **kwargs):
    ...
    def get_config(self):
        ...
        config.update({"isChannelFirst": self.isChannelFirst, "truncatedFrequencies": self.truncatedFrequencies})
        return config
...
class FourierPooling2D(tf.keras.layers.Layer):
    ...
    def __init__(self, isChannelFirst=False, **kwargs):
    ...
    def get_config(self):
        ...
        config.update({"isChannelFirst": self.isChannelFirst})
        return config
